...
import com.smart.xsoup.XTokenQueue;
...
public class Json extends PlainText {
    ...
    System.out.println("chompBalanced =  " + chompBalanced);
    ...
    public Selectable jsonPath(String jsonPath) {
     ...
     System.out.println("jsonPathSelector = " + jsonPathSelector.selectList(jsonPath));
